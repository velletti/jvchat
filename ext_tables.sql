...
CREATE TABLE tx_jvchat_room (
    ...
    showuserinfo_experts blob  DEFAULT '' NOT NULL,
    showuserinfo_moderators blob  DEFAULT '' NOT NULL,
    showuserinfo_users blob  DEFAULT '' NOT NULL,
	showuserinfo_superusers blob  DEFAULT '' NOT NULL,
	enable_emoticons SMALLINT(4) DEFAULT '0' NOT NULL,
	page  int(11) DEFAULT 0  NOT NULL,
	image blob DEFAULT '' NOT NULL,
	owner int(11) DEFAULT '0' NOT NULL,
	private SMALLINT(4) DEFAULT '0' NOT NULL,
	members blob DEFAULT '' NOT NULL,
	notifyme  blob DEFAULT ''  NOT NULL,
	PRIMARY KEY (uid),
	KEY parent (pid)
);
